...
4. **Order Logistics:** What are the different order statuses (Delivered, Refunded, Cancelled, etc.)?
5. **Geographic Distribution:** List the top 5 states contributing to sales.
6. **Age & Gender:** What is the relationship between age and gender regarding order count?
7. **Channel Performance:** Which sales channel is contributing the most (Amazon, Flipkart, Myntra, etc.)?
...
* **Data Visualization:** Created an interactive dashboard featuring Combo Charts, Pie Charts, and Bar Charts.
